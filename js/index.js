...
function validateDobEntry(){
  ...
  let todayInMsSince1970 = new Date();
  todayInMsSince1970.setFullYear(data.today.getFullYear(), data.today.getMonth(), data.today.getDate());
  todayInMsSince1970 = todayInMsSince1970.getTime();
